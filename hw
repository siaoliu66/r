...
CrossTable(survey$Exer,survey$Height,expected = T,format = "SPSS",fisher = T,prop.c = F,prop.t = F,prop.chisq = F)
...
# 2.2 計算平均分數並加入新欄
###  avg_score 這個變數可以自行改名，其他用取代方式一次取代
